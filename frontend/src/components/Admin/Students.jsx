...
const Students = () => {
  ...
  const fetchClasses = async () => {
    try {
      ...
      const response = await fetch('https://lms-ul7x.onrender.com/api/admin/classes', {
        headers: {
  ...
  const fetchSections = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('https://lms-ul7x.onrender.com/api/admin/sections', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchStudents = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('https://lms-ul7x.onrender.com/api/admin/students', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const handleAddStudent = async (formDataToSend) => {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.post('https://lms-ul7x.onrender.com/api/admin/students', 
        formDataToSend,
        {
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  const handleEditStudent = async (formDataToSend) => {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.put(`https://lms-ul7x.onrender.com/api/admin/students/${selectedStudent._id}`, 
        formDataToSend,
        {
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  const handleDeleteStudent = async (studentId) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await axios.delete(`https://lms-ul7x.onrender.com/api/admin/students/${studentId}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
